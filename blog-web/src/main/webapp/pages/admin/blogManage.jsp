...
<script type="text/javascript">
	...
	function openBlogModifyTab(){
		 ...
		 window.parent.openTab('修改博客','/pages/admin/modifyBlog.jsp?id='+row.id,'icon-writeblog');
	}
...
<table id="dg" title="博客管理" class="easyui-datagrid"
   ...
   <thead>
   	<tr>
   		...
   		<th field="blogTypeDTO" width="50" align="center" formatter="formatBlogType">博客类别</th>
   	</tr>
   </thead>
 </table>
 <div id="tb">
