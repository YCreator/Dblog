...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/contance.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/lib/ueditor/third-party/SyntaxHighlighter/shCoreDefault.css">
<link rel="stylesheet"
...
<div class="data_list">
	<div class="data_list_title">
		<img class="f_l"
			src="${pageContext.request.contextPath}/images/blog_show_icon.png" />
		博客信息
	</div>
	<div>
...
<div class="data_list">
	<div class="data_list_title">
		<img class="f_l"
			src="${pageContext.request.contextPath}/images/comment_icon.png" />
		评论信息
...
<div class="data_list">
	<div class="data_list_title">
		<img class="f_l"
			src="${pageContext.request.contextPath}/images/publish_comment_icon.png" />
		发表评论
	</div>
	<div class="publish_comment">
		...
		<div class="verCode">
			验证码：<input type="text" value="${imageCode }" name="imageCode"
				...
				width="60" height="24" border="1" align="absmiddle">
		</div>
