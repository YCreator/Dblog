...
<div class="topnews">
      <h2><!-- <span><a href="/" target="_blank">栏目标题</a><a href="/" target="_blank">栏目标题</a><a href="/" target="_blank">栏目标题</a></span> --><b>博客</b>文章</h2>
      <c:forEach var = "blog" items = "${blogList }">
	      <div class="blogs">
	        ...
	        <ul>
	          ...
	          <p class="autor"><span class="lm f_l"><a href="/">${blog.blogTypeDTO.typeName }</a></span>
